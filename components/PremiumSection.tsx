...
export default function PremiumSection() {
  return (
    <section className="relative overflow-hidden">
      {/* ───── 상단: 프리미엄 혜택 ───── */}
      <div className="relative bg-gradient-to-b from-black via-gray-800 to-black pt-20 pb-10 md:pt-28 md:pb-14">
        {/* 배경 장식 */}
      ...
      {/* ───── 하단: 취업 연계 ───── */}
      <div className="relative bg-gradient-to-b from-black via-gray-800 to-black pt-10 pb-20 md:pt-14 md:pb-28">
