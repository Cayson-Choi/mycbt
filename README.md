...
- 동영상 강의 시스템 — 카테고리별 그룹/페이지, 모달 재생, 등급 접근 제어
- 학습 메모 — 영상 시청 중 800ms 자동 저장, 마이페이지에서 모아 보기
- 외부 데이터 임포트 — cbtbank.kr 등 사이트 일괄 다운로드 + DB 입력
- 채용 연계 섹션 — 분야 분포 가로 막대 차트, 4단계 매칭 타임라인, 핵심 지표 카운트업
