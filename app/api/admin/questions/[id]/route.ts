  ...
  try {
    ...
    return NextResponse.json({
      question: {
        ...
        question_type: qType,
        choice_1: updatedQuestion.choice1,
        choice_2: updatedQuestion.choice2,
        choice_3: updatedQuestion.choice3,
        choice_4: updatedQuestion.choice4,
        choice_1_image: updatedQuestion.choice1Image,
        choice_2_image: updatedQuestion.choice2Image,
        choice_3_image: updatedQuestion.choice3Image,
        choice_4_image: updatedQuestion.choice4Image,
        answer: updatedQuestion.answer,
        answer_text: updatedQuestion.answerText,
        answer_text_image: updatedQuestion.answerTextImage,
        explanation: updatedQuestion.explanation,
        explanation_image: updatedQuestion.explanationImage,
